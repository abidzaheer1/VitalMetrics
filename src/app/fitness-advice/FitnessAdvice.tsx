...
export default function FitnessAdvice() {
  ...
  return (
    ...
    >
      ...
      <Button className="mt-4 bg-accent text-accent-foreground hover:bg-accent-foreground hover:text-accent border border-primary hover:border-transparent" onClick={() => window.location.href = '/'}>
        Home
      </Button>
    </motion.div>
      </Suspense>
